...
fn default_incident() -> String { "*".into() }
fn default_severity() -> String { ">=minor".into() }
...
impl ReputationDecision {
    pub fn accept() -> Self {
        Self { outcome: RepOutcome::Accept, matched_rule: None, error_code: None }
    }
    pub fn is_accepted(&self) -> bool { self.outcome == RepOutcome::Accept }
}
